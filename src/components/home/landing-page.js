...
import "./assets/js/jquery.bundle"
import "./assets/js/vendor/jquery.easing.min";
import "./assets/js/vendor/jquery.countdown.min";
import headerTemplate from "./header.html";
import saleTemplate from "./sale.html";
import aboutTemplate from "./about.html";
import roadmapTemplate from "./roadmap.html";
...
export default class LandingPage extends HTMLElement
{
    ...
    this.classList.add("page-top");
		$(this).append(headerTemplate);
		$(this).append(saleTemplate);
		$(this).append(aboutTemplate);
		$(this).append(roadmapTemplate);
		$(this).append(demoTemplate);
		$(this).append(teamTemplate);
			$(this).append(moreTemplate);
		$(this).append(contactTemplate);
		$(this).append(footerTemplate);
	}
